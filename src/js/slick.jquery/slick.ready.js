...
$(function() {
	$('.slick-country').slick({
		...
		prevArrow: '<button type="button" class="slick-prev  is--horizontal"><svg class="icon-svg icon-slick-left" role="img"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/svg/sprite.svg#slick-left"></use></svg></button>',
